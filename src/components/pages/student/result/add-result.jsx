          ...
          <Table>
            ...
            <TableBody>
              {results.map((result, index) => (
                <TableRow key={index}>
                  <TableCell>{result["Reg No"] || "N/A"}</TableCell>
                  <TableCell>{result.Email || "N/A"}</TableCell>
                  <TableCell>
                    {result.Admit ? <a href={result.Admit} target="_blank" className="text-blue-600">View PDF</a> : "N/A"}
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
